                ...
                $my_query = new WP_Query( $args2 );
						while ( $my_query->have_posts() ) : ?>
                                ...
                                ?>
                                        ...
                                        <a class='text-center' href='http:arcyf.com/events-encore'> <span class="more-btn btn btn-warning"> More</span></a> 
                                        <?php endwhile; ?>
                            </div>
                        </div>
						...
						while ( $my_query->have_posts() ) : ?>
                                ...
                                ?>
                                    <div class="box-text">
                                     ...
                                     <a class='text-center' href='<?php echo get_permalink()?>'><span class="more-btn btn btn-warning">Upcoming Event</span></a>
...
<div class="box-text"><?php echo get_the_title()?></div>
                            <a class='text-center' href='<?php echo get_permalink()?>'><span class="more-btn btn btn-warning">Latest Post</span></a>
